    ...
    render() {
        ...
        return(
            <ListItem button divider dense href={url} component={"a"}>
                ...
                <ListItemText disableTypography primary={<Typography display={"block"} variant={"body1"} noWrap align={"left"} gutterBottom >{this.props.name}</Typography>}
                              secondary={<Typography display={"block"} noWrap variant={"body2"} align={"left"} gutterBottom >{this.props.description}</Typography>} />
