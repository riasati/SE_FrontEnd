...
it("ChannelCard Test", () => {
  ...
  expect(pretty(container.innerHTML)).toMatchInlineSnapshot(`
    "<div class=\\"MuiButtonBase-root MuiListItem-root MuiListItem-dense MuiListItem-gutters MuiListItem-divider MuiListItem-button\\" tabindex=\\"0\\" role=\\"button\\" aria-disabled=\\"false\\">
