...
import ConsultantProfile from "../Component/User/Profile/ConsultantProfile";
...
it("ConsultantProfile Test", () => {
  act(() => {
    render(<ConsultantProfile />, container);
  });
                      ...
                      <div>
                        <form novalidate=\\"\\" style=\\"padding: 4%;\\">
                          <h6 class=\\"MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-3\\">
                            ...
                            <div class=\\"MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 MuiGrid-grid-sm-3\\"></div>
                            <div class=\\"MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12\\"><button class=\\"MuiButtonBase-root MuiButton-root MuiButton-text makeStyles-topButton-8 Mui-disabled MuiButton-fullWidth Mui-disabled\\" tabindex=\\"-1\\" type=\\"button\\" disabled=\\"\\" pendingposition=\\"center\\"><span class=\\"MuiButton-label\\"><span class=\\"MuiButton-startIcon MuiButton-iconSizeMedium\\"><i class=\\"fas fa-edit\\"></i></span>اعمال تغییرات</span></button></div>
                          </h6>
                        </form>
                      </div>
                    </div>
